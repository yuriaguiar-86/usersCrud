<div class="d-flex">
    ...
    <div class="p-2">
        ...
        <span class="d-none d-md-block">
            ...
            <?= $this->Html->link(__('Alterar Senha'), ['controller' => 'users', 'action' => 'editSenha', $user->id], ['class' => 'btn btn-outline-warning btn-sm']) ?>
            <?= $this->Form->postLink(__('Apagar'), ['controller' => 'users', 'action' => 'delete', $user->id], ['class' => 'btn btn-outline-danger btn-sm', 'confirm' => __('Deseja realmente apagar o usuário # {0}', $user->id)]) ?>
        </span>
        ...
        <div class="dropdown d-block d-md-none">
            ...
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="acoesListar">
                ...
                <?= $this->Html->link(__('Alterar Senha'), ['controller' => 'users', 'action' => 'editSenha', $user->id], ['class' => 'dropdown-item']) ?>
...
<dl class="row">
    ...
    <dt class="col-sm-3 text-truncate">Data da Alteração</dt>
